Deze handleiding biedt begeleiding bij het instellen en gebruiken van de Mosquitto broker met het meegeleverde Arduino-\/script. De Mosquitto broker maakt communicatie mogelijk tussen het Arduino-\/apparaat en andere MQTT-\/clients. Volg de onderstaande instructies om de benodigde instellingen te configureren voor succesvolle communicatie.\hypertarget{md_latex__mosquittosetup_autotoc_md35}{}\doxysection{Vereisten}\label{md_latex__mosquittosetup_autotoc_md35}
...
\end{DoxyItemize}\hypertarget{md_latex__mosquittosetup_autotoc_md36}{}\doxysection{Configuratie van het Arduino-\/script}\label{md_latex__mosquittosetup_autotoc_md36}
...
\end{DoxyEnumerate}\hypertarget{md_latex__mosquittosetup_autotoc_md37}{}\doxysection{Verbinding maken met de Mosquitto Broker}\label{md_latex__mosquittosetup_autotoc_md37}
...
\end{DoxyEnumerate}\hypertarget{md_latex__mosquittosetup_autotoc_md38}{}\doxysection{Interactie met de Mosquitto Broker}\label{md_latex__mosquittosetup_autotoc_md38}
...
\end{DoxyEnumerate}\hypertarget{md_latex__mosquittosetup_autotoc_md39}{}\doxysection{Conclusie}\label{md_latex__mosquittosetup_autotoc_md39}
