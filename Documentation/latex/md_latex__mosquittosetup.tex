Deze handleiding biedt begeleiding bij het instellen en gebruiken van de Mosquitto broker met het meegeleverde Arduino-\/script. De Mosquitto broker maakt communicatie mogelijk tussen het Arduino-\/apparaat en andere MQTT-\/clients. Volg de onderstaande instructies om de benodigde instellingen te configureren voor succesvolle communicatie.\hypertarget{md_latex__mosquittosetup_autotoc_md40}{}\doxysection{Vereisten}\label{md_latex__mosquittosetup_autotoc_md40}
...
\end{DoxyItemize}\hypertarget{md_latex__mosquittosetup_autotoc_md41}{}\doxysection{Configuratie van het Arduino-\/script}\label{md_latex__mosquittosetup_autotoc_md41}
...
\end{DoxyEnumerate}\hypertarget{md_latex__mosquittosetup_autotoc_md42}{}\doxysection{Verbinding maken met de Mosquitto Broker}\label{md_latex__mosquittosetup_autotoc_md42}
...
\end{DoxyEnumerate}\hypertarget{md_latex__mosquittosetup_autotoc_md43}{}\doxysection{Interactie met de Mosquitto Broker}\label{md_latex__mosquittosetup_autotoc_md43}
...
\end{DoxyEnumerate}\hypertarget{md_latex__mosquittosetup_autotoc_md44}{}\doxysection{Conclusie}\label{md_latex__mosquittosetup_autotoc_md44}
